...
class _CreateScreenState extends State<CreateScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const AppBars(title: "Ciptakan Resep"),
            ...
            children: [
              const Text(
                ...
                style: TextStyle(
                  ...
                  color: Color.fromARGB(255, 74, 65, 64),
                ),
              ),
              ...
              Align(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () async {
                    ...
                    var temp = await HomePageRepo().askAI(
                        judul.toString(), bahan.toString(), detail.toString());
                    setState(() => response = '');
                    if (context.mounted) {
